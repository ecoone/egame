...
egame.define("Signal",function(){
    ...
    * 
    * @class egame.SignalBinding
    * @constructor
    * @param {egame.Signal} signal - Reference to Signal object that listener is currently bound to.
    ...
    */
    egame.SignalBinding = function (signal, listener, isOnce, listenerContext, priority, args) {

        /**
        * @property {egame.Game} _listener - Handler function bound to the signal.
        * @private
        */
        ...
        /**
        * @property {egame.Signal} _signal - Reference to Signal object that listener is currently bound to.
        * @private
        */
        this._signal = signal;
    ...
    egame.SignalBinding.prototype = {
        ...
        * @method egame.SignalBinding#execute
        ...
        * @method egame.SignalBinding#detach
        ...
        */
        ...
        /**
        * @method egame.SignalBinding#isBound
        ...
        */
        ...
        /**
        * @method egame.SignalBinding#isOnce
        ...
        */
        ...
        /**
        * @method egame.SignalBinding#getListener
        ...
        */
        ...
        /**
        * @method egame.SignalBinding#getSignal
        * @return {egame.Signal} Signal that listener is currently bound to.
        */
        getSignal: function () {
            return this._signal;
        },
        ...
        * @method egame.SignalBinding#_destroy
        * @private
        */
        _destroy: function () {
            delete this._signal;
        ...
        /**
        * @method egame.SignalBinding#toString
        * @return {string} String representation of the object.
        */
        toString: function () {
            return '[egame.SignalBinding isOnce:' + this._isOnce +', isBound:'+ this.isBound() +', active:' + this.active + ']';
        }

    };

    egame.SignalBinding.prototype.constructor = egame.SignalBinding;
    ...
    * @constructor
    */
    egame.Signal = function () {
    };

    egame.Signal.prototype = {

        /**
        * @property {?Array.<egame.SignalBinding>} _bindings - Internal variable.
        * @private
        */
        _bindings: null,
        ...
        */
        ...
        /**
        * @method egame.Signal#validateListener
        ...
        */
        validateListener: function (listener, fnName) {
            ...
            {
                throw new Error('egame.Signal: listener is a required param of {fn}() and should be a Function.'.replace('{fn}', fnName));
            }

        },

        /**
        * @method egame.Signal#_registerListener
        * @private
        * @param {function} listener - Signal handler function.
        ...
        * @return {egame.SignalBinding} An Object representing the binding between the Signal and listener.
        */
        _registerListener: function (listener, isOnce, listenerContext, priority, args) {
            ...
            {
                binding = new egame.SignalBinding(this, listener, isOnce, listenerContext, priority, args);
        ...
        /**
        * @method egame.Signal#_addBinding
        * @private
        * @param {egame.SignalBinding} binding - An Object representing the binding between the Signal and listener.
        */
        ...
        /**
        * @method egame.Signal#_indexOfListener
        * @private
        * @param {function} listener - Signal handler function.
        ...
        *
        * For example: `egame.Key.onDown` when dispatched will send the egame.Key object that caused the signal as the first parameter.
        * Any arguments you've specified after `priority` will be sent as well:
        *
        * `fireButton.onDown.add(shoot, this, 0, 'lazer', 100);`
        *
        * When onDown dispatches it will call the `shoot` callback passing it: `egame.Key, 'lazer', 100`.
        *
        ...
        *
        * If there is as {@link egame.Signal#memorize memorized} event then it will be dispatched and
        * the listener will be removed immediately.
        *
        * @method egame.Signal#addOnce
        * @param {function} listener - The function to call when this Signal is dispatched.
        * @param {object} [listenerContext] - The context under which the listener will be executed (i.e. the object that should represent the `this` variable).
        * @param {number} [priority] - The priority level of the event listener. Listeners with higher priority will be executed before listeners with lower priority. Listeners with same priority level will be executed at the same order as they were added (default = 0)
        * @param {...any} [args=(none)] - Additional arguments to pass to the callback (listener) function. They will be appended after any arguments usually dispatched.
        ...
        */
        remove: function (listener, context) {
            ...
            if (i !== -1)
            {
                this._bindings[i]._destroy(); //no reason to a egame.SignalBinding exist if it isn't attached to a signal
        ...
        *
        * @method egame.Signal#getNumListeners
        ...
        */
        ...
        /**
        * Forget the currently {@link egame.Signal#memorize memorized} event, if any.
        *
        * @method egame.Signal#forget
        */
        forget: function() {
        ...
        *
        * @method egame.Signal#toString
        * @return {string} String representation of the object.
        */
        toString: function () {

            return '[egame.Signal active:'+ this.active +' numListeners:'+ this.getNumListeners() +']';
    ...
    *
    * @memberof egame.Signal
    * @property {function} boundDispatch
    */
    Object.defineProperty(egame.Signal.prototype, "boundDispatch", {
    ...
    egame.Signal.prototype.constructor = egame.Signal;
